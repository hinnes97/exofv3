...
use                  fms_mod,  only: stdlog, check_nml_error,&
                                    stdout, &
                                     input_nml_file
...
subroutine mixed_layer_init(is, ie, js, je, num_levels, axes, Time)
...
ierr=1
read  (input_nml_file, nml=mixed_layer_nml, iostat=io)
