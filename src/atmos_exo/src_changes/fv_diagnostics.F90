...
#  endif WATER_CYCLE
 ...
 integer ::id_ps, id_slp, id_ua, id_va, id_pt, id_tsurf, id_omga, id_vort,  &
...
! tracers
 ...
 public :: fv_diag_init, fv_time, fv_diag, prt_maxmin, range_check, id_divg, id_te, get_height_field
...
!!!  This will need mods for more than 1 tile per pe  !!!
   ...
   rhrange = (/  -10.,  150. /)  ! RH
    ...
    slprange = (/80.,  12000./)  ! sea-level-pressure
#endif
...
!-------------------
       ...
       id_tsurf   = register_diag_field ( trim(field), 'tsurf', axes(1:2), Time,       &
            'temperature', 'K', missing_value=missing_value, range=trange )
...
! 850-mb
       ...
       if(id_tsurf   > 0) used=send_data(id_tsurf  , Atm(n)%tsurf  (isc:iec,jsc:jec), Time)
