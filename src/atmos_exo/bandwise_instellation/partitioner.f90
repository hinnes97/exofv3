    ...
    subroutine read_stellar_spectrum(star)
      ...
      select case(star)
        case('Sun')
          ...
          spectrum_path = '../stars/Sun/lean_12' 
        ...
        case('GJ551')
          ...
          spectrum_path = '../stars/GJ551/sflux-GJ551.txt'
          open(11,file=spectrum_path)
          read(11,*)
          do i=1, size(spectrum,2)
            read(11,*) spectrum(1,i), spectrum(2,i) 
        ...
        case('Trappist1')
          allocate(spectrum(2,83284))
          spectrum_path = '../stars/TRAPPIST-1/TRAPPIST-1.txt'
          open(11,file=spectrum_path)
          read(11,*)
          read(11,*)
          read(11,*)
